...
package com.example.recyclersample.carneDetail
...
import com.example.recyclersample.carneList.FLOWER_ID

class CarneDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.carne_detail_activity)

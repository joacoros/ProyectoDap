...
import com.example.recyclersample.addCarne.AddFlowerActivity
import com.example.recyclersample.carneDetail.CarneDetailActivity
import com.example.recyclersample.R
import com.example.recyclersample.addCarne.FLOWER_DESCRIPTION
import com.example.recyclersample.addCarne.FLOWER_NAME
...
class FlowersListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        flowersListViewModel.flowersLiveData.observe(this, {
            it?.let {
                flowersAdapter.submitList(it as MutableList<Carne>)
    ...
    private fun adapterOnClick(carne: Carne) {
        val intent = Intent(this, CarneDetailActivity()::class.java)
        intent.putExtra(FLOWER_ID, carne.id)
